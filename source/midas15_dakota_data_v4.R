...
# | Created: 04/21/2017                                                    |
# | Modified: 01/19/2018, clead MIDAS data                                 |
# |------------------------------------------------------------------------|
# Header----
# Save consol output to a log file
# sink(file = "tmp/log_midas15_cied_data_v3.txt")
...
temp_midas15 = midas15
#midas15 <- droplevels(subset(midas15,
#                             ADM_TYPE %in% c("Inpatinet Before 2008", "Inpatient")))
mida15 = midas15[midas15$ADM_TYPE %in% c(1,3,4,5),]
...
save(midas15, dx, dx.1.3,  
     file = "midas15_dakota_01192018.RData", 
     compress = FALSE)

#**********************************************************
# PART II----
load("midas15_dakota_01192018.RData")
...
# 1,645,160 (?) records for 237,891 patients
...
dt1 <- droplevels(dt1)
summary(dt1)
save(dt1, file = "dt1_01192018.RData", compress = FALSE)

#**********************************************************
# PART III----
load("dt1_01192018.RData")
